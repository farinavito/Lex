...
def new_agreement_8(deploy):
    return deploy.createAgreement(accounts[9], 10**18, agreement_duration, 31556926, {'from': accounts[1]})
...
def test_exactAgreement_check_large_amount(deploy):
    ...
    assert deploy.exactAgreement(1)[3] == amount_sent 
...
def test_MySenderAgreements_emits_correctly_agreementSignee_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementSignee'] == deploy.exactAgreement(0)[1]
...
def test_MySenderAgreements_emits_correctly_agreementReceiver_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementReceiver'] == deploy.exactAgreement(0)[2]
...
def test_MySenderAgreements_emits_correctly_agreementAmount_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementAmount'] == deploy.exactAgreement(0)[3]
...
def test_MySenderAgreements_emits_correctly_agreementTransactionCreated(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementTransactionCreated'] == deploy.exactAgreement(0)[4]
...
def test_MySenderAgreements_emits_correctly_agreementDeposit_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementDeposit'] == deploy.exactAgreement(0)[5]
...
def test_MySenderAgreements_emits_correctly_agreementStatus_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementStatus'] == deploy.exactAgreement(0)[6]
...
def test_MySenderAgreements_emits_correctly_agreementApproved_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementApproved'] == deploy.exactAgreement(0)[7]
...
def test_MySenderAgreements_emits_correctly_agreementTimePeriods_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementTimePeriods'] == deploy.exactAgreement(0)[9]
...
def test_MySenderAgreements_emits_correctly_agreementPositionPeriod_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementPositionPeriod'] == deploy.exactAgreement(0)[10]
...
def test_MySenderAgreements_emits_correctly_agreementTimeDuration_agreements_1(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[0]['agreementTimeDuration'] == deploy.exactAgreement(0)[11]
...
def test_MySenderAgreements_emits_correctly_agreementId_agreements_2(deploy):
    ...
    assert deploy.MySenderAgreements(accounts[1], {'from': accounts[1]}).events[1]['agreementId'] == deploy.exactAgreement(1)[0]
...
def test_MyReceiverAgreements_emits_correctly_agreementId_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementId'] == deploy.exactAgreement(0)[0]
...
def test_MyReceiverAgreements_emits_correctly_agreementSignee_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementSignee'] == deploy.exactAgreement(0)[1]
...
def test_MyReceiverAgreements_emits_correctly_agreementReceiver_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementReceiver'] == deploy.exactAgreement(0)[2]
...
def test_MyReceiverAgreements_emits_correctly_agreementAmount_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementAmount'] == deploy.exactAgreement(0)[3]
...
def test_MyReceiverAgreements_emits_correctly_agreementTransactionCreated_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementTransactionCreated'] == deploy.exactAgreement(0)[4]
...
def test_MyReceiverAgreements_emits_correctly_agreementDeposit_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementDeposit'] == deploy.exactAgreement(0)[5]
...
def test_MyReceiverAgreements_emits_correctly_agreementStatus_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementStatus'] == deploy.exactAgreement(0)[6]
...
def test_MyReceiverAgreements_emits_correctly_agreementApproved_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementApproved'] == deploy.exactAgreement(0)[7]
...
def test_MyReceiverAgreements_emits_correctly_agreementTimeCreation_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementTimeCreation'] == deploy.exactAgreement(0)[8]
...
def test_MyReceiverAgreements_emits_correctly_agreementTimePeriods_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementTimePeriods'] == deploy.exactAgreement(0)[9]
...
def test_MyReceiverAgreements_emits_correctly_agreementPositionPeriod_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementPositionPeriod'] == deploy.exactAgreement(0)[10]
...
def test_MyReceiverAgreements_emits_correctly_agreementTimeDuration_agreements_1(deploy):
    ...
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[0]['agreementTimeDuration'] == deploy.exactAgreement(0)[11]

def test_MyReceiverAgreements_emits_correctly_agreementId_agreements_2(deploy):
    '''check if the MyReceiverAgreements function emits correctly the agreementId from agreement 1'''
    assert deploy.MyReceiverAgreements(accounts[9], {'from': accounts[9]}).events[1]['agreementId'] == '1'
...
def test_myReceiverAgreements_emits_correct_id_agreement_1(deploy):
    ...
    assert deploy.myReceiverAgreements(accounts[9], 0) == '0'
...
def test_ConfirmAgreement_agreement_already_confirmed(deploy):
    ...
    function_enabled = deploy.ConfirmAgreement(0, {'from': accounts[9]})
...
def test_terminateContract_emit_Terminated_initial_status_activated_already_terminated(deploy):
    ...
    deploy.ConfirmAgreement(0, {'from': accounts[9]})
    deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
...
def test_transfer_deposit_back_to_signee(deploy, value_sent):
    ...
    deploy.ConfirmAgreement(0, {'from': accounts[9]})
    deploy.sendPayment(0, {'from': accounts[1], 'value': value_sent})
...
def test_sendPayments_change_agreementDeposit_initial_status_created(deploy):
    ...
    deploy.ConfirmAgreement(0, {'from': accounts[9]})
    deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
    assert deploy.exactAgreement(0)[5] == '1000000000000000000'
...
def test_sendPayments_emit_NotifyUser_initial_status_created(deploy):
    ...
    deploy.ConfirmAgreement(0, {'from': accounts[9]})
    function_enabled = deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
    message = function_enabled.events[0][0]['message']
...
def test_timeNotBreached_value_large_amount_emit_NotifyUser(deploy):
    ...
    function_initialize = deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
...
def test_timeNotBreached_value_smaller_amount_send_deposit(deploy, value_sent):
    ...
    balance_receiver = accounts[9].balance() 
    deploy.sendPayment(0, {'from': accounts[1], 'value': value_sent}) 
    assert accounts[9].balance() == balance_receiver + amount_sent
...
def test_timeNotBreached_value_smaller_amount_emit_Terminated(deploy, value_sent):
    ...
    deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
    #the contract has been activated, now send the smaller quantity of money again
    function_initialize = deploy.sendPayment(0, {'from': accounts[1], 'value': value_sent})
...
def test_timeNotBreached_breached_on_time_false_send_deposit(deploy, seconds_sleep):
    ...
    chain = Chain()
    chain.sleep(seconds_sleep)
    deploy.sendPayment(0, {'from': accounts[1], 'value': 4*amount_sent}) 
    assert accounts[9].balance() == balance_receiver + amount_sent
...
def test_wasContractBreached_timeNotBreached_true_emit_NotifyUser(deploy):
    ...
    deploy.ConfirmAgreement(0, {'from': accounts[9]})
    deploy.sendPayment(0, {'from': accounts[1], 'value': amount_sent})
    function_initialize = deploy.wasContractBreached(0, {'from': accounts[9]})
