...
#hardcoded parametrized values
'''
    "seconds_sleep",  [agreement_duration, 2630000, 2640000] -> test_ConfirmAgreement_fail_require_2  ### more than its agreement_duration
    "seconds_sleep", [0, 260, 2640, 2629700] -> test_ConfirmAgreement_fail_require_2_pair             ### less than its agreement_duration

    "accounts_number", [1, 2, 3, 4, 5, 6, 7]) -> test_ConfirmAgreement_fail_require_1                 ### with no receiver
    "accounts_number", [9]) -> test_ConfirmAgreement_fail_require_1_pair                              ### with receiver

    "accounts_number", [2, 3, 4, 5, 6, 7]) -> test_terminateContract_fails_require_wrong_address_initial_status_activated       ### with no signee
    "accounts_number", [1]) -> test_terminateContract_fails_require_wrong_address_initial_status_activated_pair                 ### with signee

    "value_sent", [amount_sent, 11**18, 12**18]) -> test_transfer_deposit_back_to_signee            ### more or equal to amount_sent 
    "value_sent", [1, 7**18, 9**18]) -> test_transfer_deposit_back_to_signee_pair                   ### less than amount sent

    "accounts_number", [2, 3, 4, 5, 6, 7]) -> test_terminateContract_fails_require_wrong_address_initial_status_activated_without_sendPayments      ### with no signee
    "accounts_number", [1]) -> test_terminateContract_fails_require_wrong_address_initial_status_activated_without_sendPayments_pair                ### with signee

    "accounts_number", [2, 3, 4, 5, 6, 7, 8, 9]) -> test_sendPayments_fails_require_wrong_address
    "accounts_number", [1]) -> test_sendPayments_fails_require_wrong_address_pair

    "seconds_sleep",  [agreement_duration, 2630000, 2640000]) -> test_sendPayments_require_statement_fails_agreement_not_ended          ### more than its agreement_duration
    "seconds_sleep",  [1, 26300, 264000]) -> test_sendPayments_require_statement_fails_agreement_not_ended_pair                         ### less than its agreement_duration

    "value_sent",  [0, 1, 10**7, 10**17]) -> test_sendPayments_fails_require_smaller_deposit_initial_status_created                 ### less than amount sent
    "value_sent",  [amount_sent, 10**19]) -> test_sendPayments_fails_require_smaller_deposit_initial_status_created_pair            ### more or equal to amount_sent
    
    "seconds_sleep",  [agreement_duration, 2630000, 2640000]) -> test_timeNotBreached_fail_if_statement             ### more than its agreement_duration
    "seconds_sleep",  [0, 26300, 26400]) -> test_timeNotBreached_fail_if_statement_pair                             ### less than its agreement_duration

    "value_sent",  [amount_sent, 10**19]) -> test_timeNotBreached_value_large_amount_send_value                                             ### more or equal to amount_sent
    "value_sent",  [amount_sent], "value_decreased",  [10**2, 10**3, 10**4] -> test_timeNotBreached_value_large_amount_send_value_pair      ### less than amount sent

    "value_sent",  [amount_sent, 10**19]) -> test_timeNotBreached_value_large_amount_send_value_check_signee                                                ### more or equal to amount_sent
    "value_sent",  [amount_sent], "value_decreased",  [10**2, 10**3, 10**4] -> test_timeNotBreached_value_large_amount_send_value_check_signee_pair         ### less than amount sent

    "value_sent",  [0, 1, amount_sent - 10**2] -> test_timeNotBreached_value_smaller_amount_status                                                  ### less than amount sent
    "value_sent",  [amount_sent, amount_sent + 10**2, amount_sent + 10**3] -> test_timeNotBreached_value_smaller_amount_status_pair                 ### more or equal to amount_sent      

    "value_sent",  [0, 1, amount_sent - 10**2] -> test_timeNotBreached_value_smaller_amount_send_deposit                                            ### less than amount sent
    "value_sent",  [amount_sent, amount_sent + 10**2, amount_sent + 10**3] -> test_timeNotBreached_value_smaller_amount_send_deposit_pair           ### more or equal to amount_sent

    "value_sent",  [0, 1, amount_sent - 10**2] -> test_timeNotBreached_value_smaller_amount_deposit_equals_zero                                     ### less than amount sent
    "value_sent",  [amount_sent, amount_sent + 10**2, amount_sent + 10**3] -> test_timeNotBreached_value_smaller_amount_deposit_equals_zero_pair    ### more or equal to amount_sent

    "value_sent",  [0, 1, amount_sent - 10**2] -> test_timeNotBreached_value_smaller_amount_return_transaction                                      ### less than amount sent
    "value_sent",  [amount_sent, amount_sent + 10**2, amount_sent + 10**3] -> test_timeNotBreached_value_smaller_amount_return_transaction_pair     ### more or equal to amount_sent

    "value_sent",  [0, 1, amount_sent - 10**2] -> test_timeNotBreached_value_smaller_amount_emit_Terminated                                         ### less than amount sent
    "value_sent",  [amount_sent, amount_sent + 10**2, amount_sent + 10**3] -> test_timeNotBreached_value_smaller_amount_emit_Terminated_pair        ### more or equal to amount_sent

    "seconds_sleep",  [every_period, 604801, 688888]) -> test_timeNotBreached_received_on_time_false_1st_part_if_statement
    "seconds_sleep",  [60*60*24*7, 60*60*24*8, 60*60*24*10] -> test_timeNotBreached_received_on_time_false_2nd_part_if_statement
    "seconds_sleep",  [2240000, agreement_duration, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_3rd_part_if_statement

    "seconds_sleep",  [every_period, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_status                       ### more than its agreement_duration
    "seconds_sleep",  [0, 260000, 262900] -> test_timeNotBreached_breached_on_time_false_status_pair                                ### less than its agreement_duration

    "seconds_sleep",  [every_period, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_send_deposit                 ### more than its agreement_duration
    "seconds_sleep",  [0, 260000, 262900] -> test_timeNotBreached_breached_on_time_false_send_deposit_pair                          ### less than its agreement_duration

    "seconds_sleep",  [every_period, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_deposit_equals_zero          ### more than its agreement_duration
    "seconds_sleep",  [0, 260000, 262900] -> test_timeNotBreached_breached_on_time_false_deposit_equals_zero_pair                   ### less than its agreement_duration

    "seconds_sleep",  [every_period, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_return_transaction           ### more than its agreement_duration
    "seconds_sleep",  [0, 260000, 262900] -> test_timeNotBreached_breached_on_time_false_return_transaction_pair                    ### less than its agreement_duration

    "seconds_sleep",  [every_period, 2629744, 26297440] -> test_timeNotBreached_breached_on_time_false_emit_Terminated              ### more than its agreement_duration
    "seconds_sleep",  [0, 260000, 262900] -> test_timeNotBreached_breached_on_time_false_emit_Terminated_pair                       ### less than its agreement_duration

    -------------------

    "wrong_accounts",  [0, 1, 2, 3, 4] -> test_wasContractBreached_require_receiver_equals_msg_sender                               ### with no receiver
    "right_accounts",  [9] -> test_wasContractBreached_require_receiver_equals_msg_sender_pair                                      ### with receiver

    "seconds_sleep",  [every_period, 604801, 688888] -> test_wasContractBreached_timeNotBreached_false_status_Terminated            ### more than its every_period
    "seconds_sleep",  [0, 260000, 262900] -> test_wasContractBreached_timeNotBreached_false_status_Terminated_pair                  ### less than its every_period

    "seconds_sleep",  [every_period, 604801, 688888] -> test_wasContractBreached_timeNotBreached_false_send_deposit                 ### more than its every_period
    "seconds_sleep",  [0, 260000, 262900] -> test_wasContractBreached_timeNotBreached_false_send_deposit_pair                       ### less than its every_period

    "seconds_sleep",  [every_period, 604801, 688888] -> test_wasContractBreached_timeNotBreached_false_status_deposit_equals_zero_1 ### more than its every_period
    "seconds_sleep",  [0, 260000, 262900] -> test_wasContractBreached_timeNotBreached_false_status_deposit_equals_zero_1_pair       ### less than its every_period

    "seconds_sleep",  [every_period, 604801, 688888] -> test_wasContractBreached_timeNotBreached_false_emit_Terminated              ### more than its every_period
    "seconds_sleep",  [0, 260000, 262900] -> test_wasContractBreached_timeNotBreached_false_emit_Terminated_pair                    ### less than its every_period
...
def test_MySenderAgreements_fails_require(deploy):
    ...
    try:
        ...
        deploy.MySenderAgreements(accounts[signee], {'from': accounts[3]})
    except Exception as e:
...
def test_MyReceiverAgreements_fails_require(deploy):
    ...
    try:
        #wrong sender's address
        deploy.MyReceiverAgreements(accounts[signee], {'from': accounts[3]})
    except Exception as e:
        assert e.message[50:] == "The address provided doesn't correspond with the one you're logged in"
